...
//                                                    map.put(0, "фантастика");
//                                                    map.put(1, "приключения");
//                                                    map.put(2, "детективы");
//                                                    map.put(3, "фэнтези");
//                                                    map.put(4, "наука");
//                                                    map.put(5, "классика");
//                                                    map.put(6, "научно-популярное");
//                                                    db.document(user).collection("genres").document("genres").set(map);
